...
Recommended Coffee : {8}
============================================
""".format(customer_name,bill_no,current_date,current_time,total,gst,discount,grand_total,suggestion)

    result.config(text=bill_text)
...
Radiobutton(root,text="HOT",
variable=temp_var,value="HOT").pack()
